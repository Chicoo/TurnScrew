...
namespace TurnScrew.Wiki.SearchEngine
{
    ...
    public class SearchResultCollection : ICollection<SearchResult>
    {
        ...
        /// </summary>
        protected List<SearchResult> _items;

        /// <summary>
        /// Initializes a new instance of the <see cref="SearchResultCollection" /> Class.
        /// </summary>
        public SearchResultCollection() : this(10)
        { }
        ...
        public SearchResultCollection(int capacity)
        {
            ...
            _items = new List<SearchResult>(capacity);
        }
        ...
        public void Add(SearchResult item)
        {
            ...
            foreach (SearchResult r in _items)
            {
        ...
        public bool Contains(SearchResult item)
        {
            ...
            else return _items.Contains(item);
        }
        ...
        public SearchResult this[int index]
        {
            get
            {
                if (index < 0 || index > _items.Count - 1) throw new IndexOutOfRangeException("Index should be greater than or equal to zero and less than the number of items in the collection.");
