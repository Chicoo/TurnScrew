...
namespace TurnScrew.Wiki.SearchEngine
{
    ...
    public class SortedBasicWordInfoSet : IEnumerable<BasicWordInfo>
    {
        ...
        public SortedBasicWordInfoSet(int capacity)
        {
            ...
            _items = new List<BasicWordInfo>(capacity);
        }
        ...
        {
            int idx = _items.BinarySearch(item);
        ...
        public BasicWordInfo this[int index]
        {
            get
            {
                if (index < 0 || index > _items.Count - 1) throw new IndexOutOfRangeException("Index should be greater than or equal to zero and less than the number of items in the set.");
                return _items[index];
            }
        }
