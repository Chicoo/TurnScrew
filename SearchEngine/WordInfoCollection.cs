...
namespace TurnScrew.Wiki.SearchEngine
{
    ...
    public class WordInfoCollection : ICollection<WordInfo>
    {
        ...
        public WordInfoCollection(int capacity)
        {
            ...
            _items = new List<WordInfo>(capacity);
        }
        ...
        public void Add(WordInfo item)
        {
            ...
            // Sort
            _items.Sort(delegate (WordInfo mi1, WordInfo mi2) { return mi1.FirstCharIndex.CompareTo(mi2.FirstCharIndex); });
        }
        ...
        {
            return _items.Count.ToString() + " matches";
        }
    }
}
