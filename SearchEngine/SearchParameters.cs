...
namespace TurnScrew.Wiki.SearchEngine
{
    ...
    public class SearchParameters
    {
        ...
        /// </summary>
        /// <param name="query">The search query.</param>
        public SearchParameters(string query) : this(query, null, SearchOptions.AtLeastOneWord) { }
        ...
        /// <param name="query">The search query.</param>
        /// <param name="documentTypeTags">The document type tags to include in the search, or <c>null</c>.</param>
        public SearchParameters(string query, params string[] documentTypeTags) : this(query, documentTypeTags, SearchOptions.AtLeastOneWord) { }
        ...
        /// <param name="query">The search query.</param>
        /// <param name="options">The search options.</param>
        public SearchParameters(string query, SearchOptions options) : this(query, null, options) { }
